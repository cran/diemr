...
The `vcf2diem` function processes **diploid** data at this time. The marker order will be identical to that in the original vcf file. 
...
Including invariant markers in genome polarisation is acceptable, and likely unavoidable. A proportion of truly invariant markers will be mis-diagnosed as variant due to sequencing error.
