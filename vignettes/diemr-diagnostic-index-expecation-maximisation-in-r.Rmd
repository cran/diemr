...
`diemr` lies in the safety that the user does not need to determine the true assignment to the 
...
individuals influence calculation of the hybrid index, which in turn has an effect on the diem analysis.
...
Baird S. J. E., Petruzela J., Jaron I., Skrabanek P., Martinkova N. 2022. diemr: Genome polarisation for detecting barriers to geneflow in R. bioRxiv 2022.03.24.485605, doi: 10.1101/2022.03.24.485605.